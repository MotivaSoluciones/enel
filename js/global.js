...
$(function() {
    ...
    $(document).ready(function() {
    	$('#cerrar.open-addcar').click(function(){
	    	$('#add-imprimir.overlay-popup.visible').removeClass('active');
    	setTimeout(function(){$('#add-imprimir.overlay-popup.visible').removeClass('visible');}, 500);
	    	return false;
    	});
    });
